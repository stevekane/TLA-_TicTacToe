...
\begin{document}
\tlatex
\@x{}\moduleLeftDash\@xx{ {\MODULE} TicTacToe}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Integers ,\, Sequences}%
\@x{ {\VARIABLES} turnState ,\, board}%
\@x{ {\CONSTANTS} PlayerCount ,\, BoardSize}%
\@pvspace{8.0pt}%
\@x{ Index\@s{33.91} \.{\defeq} 0 \.{\dotdot} ( BoardSize \.{-} 1 )}%
\@x{ TurnState\@s{14.62} \.{\defeq} 0 \.{\dotdot} ( PlayerCount \.{-} 1 )}%
\@x{ First\@s{36.77} \.{\defeq} 0}%
\@x{ Empty\@s{29.81} \.{\defeq} \.{-} 1}%
\@x{ CellState\@s{18.84} \.{\defeq} TurnState \.{\cup} \{ Empty \}}%
\@x{ CellIndex\@s{16.54} \.{\defeq} [ x \.{:} Index ,\, y \.{:} Index ]}%
\@x{ Board\@s{32.34} \.{\defeq} [ CellIndex \.{\rightarrow} CellState ]}%
\@x{ EmptyBoard\@s{4.1} \.{\defeq} [ c \.{\in} CellIndex \.{\mapsto} Empty ]}%
\@x{ NonZeroNat\@s{4.41} \.{\defeq} Nat \.{\,\backslash\,} \{ 0 \}}%
\@pvspace{8.0pt}%
\@x{ TypeOK \.{\defeq}}%
\@x{\@s{16.4} \.{\land}\@s{9.74} PlayerCount \.{\in} NonZeroNat}%
\@x{\@s{16.4} \.{\land}\@s{9.74} BoardSize \.{\in} NonZeroNat}%
\@x{\@s{16.4} \.{\land}\@s{9.74} turnState\@s{2.43} \.{\in} TurnState}%
\@x{\@s{16.4} \.{\land}\@s{9.74} board \.{\in} Board}%
\@pvspace{8.0pt}%
\@x{ BeginNewGame \.{\defeq}}%
\@x{\@s{16.4} \.{\land} turnState \.{'} \.{=} First}%
\@x{\@s{16.4} \.{\land} board \.{'} \.{=} EmptyBoard}%
\@pvspace{8.0pt}%
\@x{ TakeTurn \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} turnState \.{'} \.{=} ( turnState \.{+} 1 ) \.{\%}
 PlayerCount}%
\@x{\@s{16.4} \.{\land} \E\, c \.{\in} CellIndex \.{:}}%
\@x{\@s{31.61} \.{\land} board [ c ] \.{=} Empty}%
 \@x{\@s{31.61} \.{\land} board \.{'} \.{=} [ board {\EXCEPT} {\bang} [ c ]
 \.{=} turnState ]}%
\@pvspace{8.0pt}%
\@x{ GameOver \.{\defeq}}%
 \@x{\@s{16.4} \.{\lor} \A\, c \.{\in} CellIndex\@s{1.91} \.{:} board [ c ]
 \.{\neq} Empty}%
\@x{\@s{16.4} \.{\lor} \E\, t\@s{0.89} \.{\in} TurnState \.{:}}%
 \@x{\@s{31.61} \.{\lor} \E\, x \.{\in} Index\@s{3.40} \.{:} \A\, y\@s{0.10}
 \.{\in} Index \.{:} board [ [ x \.{\mapsto} x ,\, y \.{\mapsto} y ] ] \.{=}
 t}%
 \@x{\@s{31.61} \.{\lor} \E\, y\@s{0.10} \.{\in} Index\@s{3.40} \.{:} \A\, x
 \.{\in} Index \.{:} board [ [ x \.{\mapsto} x ,\, y \.{\mapsto} y ] ] \.{=}
 t}%
 \@x{\@s{31.61} \.{\lor} \A\, i\@s{1.75} \.{\in} Index\@s{3.40} \.{:} board [
 [ x \.{\mapsto} i ,\, y \.{\mapsto} BoardSize \.{-} 1 \.{-} i ] ] \.{=} t}%
 \@x{\@s{31.61} \.{\lor} \A\, i\@s{1.75} \.{\in} Index\@s{3.40} \.{:} board [
 [ x \.{\mapsto} i ,\, y \.{\mapsto} i ] ] \.{=} t}%
\@pvspace{8.0pt}%
 \@x{ Init\@s{4.12} \.{\defeq} turnState \.{=} First \.{\land} board \.{=}
 EmptyBoard}%
\@pvspace{8.0pt}%
 \@x{ Next \.{\defeq} {\IF} GameOver \.{\THEN} BeginNewGame \.{\ELSE}
 TakeTurn}%
\@x{}\bottombar\@xx{}%
\end{document}
